...
'Graph Model': 'Модель графа',
'Group ID': 'Group ID',
'Groups': 'Groups',
'Hello World': 'Заработало!',
"Hello World! I'm John. How are you": "Hello World! I'm John. How are you",
'Home': 'Home',
...
'profile': 'профиль',
'pygraphviz library not found': 'Библиотека pygraphviz не найдена',
'Python': 'Python',
'Query:': 'Запрос:',
